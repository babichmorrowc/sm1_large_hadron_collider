...
We consider three increasing cases of variables elimination:
1) Removing all 4 algebraic co-dependencies
2) Removing the above and any uniform variables.
3) Removing the above and the 10 variables with lowest mutual information.
